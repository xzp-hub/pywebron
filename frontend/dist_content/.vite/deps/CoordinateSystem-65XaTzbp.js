import { At as identity, Bn as keys, Cn as filter, E as CompoundPath, En as indexOf, Fn as isObject$1, Ft as scale, Gn as mixin, H as Displayable, Hn as map, It as translate, J as Eventful, Jn as reduce, Kn as noop, Ln as isString, M as ZRImage, Nt as mul, On as isArray, Ot as copy, P as Path, Pn as isNumber, Pt as rotate, Sn as extend, Tn as hasOwn, Tt as sub, Un as merge, Wn as mergeAll, Xn as retrieve2, Y as BoundingRect, Yn as retrieve, Z as cloneValue, Zn as retrieve3, _ as stop, _n as curry, bn as each$2, bt as min, cn as modifyHSL, d as Group, er as trim, fn as assert, ft as copy$1, gn as createHashMap, h as isMiddleOrRightButtonOnMouseUpDown, j as TSpan, jn as isFunction, jt as invert, kn as isArrayLike, kt as create, ln as parse, mn as clone, ot as TRANSFORMABLE_PROPS, pn as bind, rn as fastLerp, sn as modifyAlpha, st as Transformable, un as stringify, ut as applyTransform, v as ZRText, vn as defaults, x as Rect, xn as eqNaN, xt as normalize, yt as max } from "./graphic-Bd3Ikl7D.js";
import { Ai as parsePercent, Ar as SPECIAL_STATES, Bn as setLabelStyle, Br as setDefaultStateProxy, C as IntervalScale, Ci as getPrecisionSafe, Cr as Polygon, Ct as clear, D as isValueNice, Dr as Circle, E as isIntervalOrLogScale, Ei as linearMap, Er as Ellipse, Fi as remRadian, Fr as enterEmphasis, Gt as retrieveRawValue, Hn as applyTransform$1, Ii as round$1, In as createTextStyle, Jr as SINGLE_REFERRING, Kr as makeStyleMapper, Li as __extends, Nn as Model, O as OrdinalMeta, Or as createFromString, Ot as ComponentView, Q as registerAction, Rn as getLabelStatesModels, Rr as leaveEmphasis, Sr as Polyline, T as increaseInterval, Ti as isRadianAroundZero, Un as clipPointsByRect, Ur as toggleHoverEmphasis, Wr as getECData, Yn as getTransform$1, Zn as groupTransition, Zr as defaultEmphasis, _r as RadialGradient, br as BezierCurve, c as createScaleByModel, cr as traverseElements, d as getDataDimensionsOnAxis, dr as removeElement, f as getScaleExtent, fn as getLayoutParams, gi as warn, gr as OrientedBoundingRect, gt as normalizeSymbolSize, h as shouldShowAllLabels, ht as normalizeSymbolOffset, i as GeoSVGRegion, ir as setTooltipConfig, jn as getUID, jr as enableComponentHighDownFeatures, l as estimateLabelUnionRect, lr as getAnimationConfig, m as niceScaleExtent, mn as mergeLayoutParam, mr as updateProps, mt as createSymbol$1, n as parseGeoJSON, oi as normalizeToArray, on as ComponentModel, or as subPixelOptimizeLine, p as ifAxisCrossZero, pn as getLayoutRect, pr as saveOldStyle, pt as createOrUpdatePatternFromDecal, r as GeoJSONRegion, ri as makeInner, s as AxisModelCommonMixin, sr as transformDirection, t as Axis, tr as mergePath, un as fetchLayoutMode, ur as initProps, vi as asc, vr as LinearGradient, vt as findEventDispatcher, wr as Ring, wt as createOrUpdate, xr as Line$1, z as DataDiffer } from "./Axis--lthWc4Q.js";
...
function hideOverlap(labelList) {
	...
	for (var i = 0; i < labelList.length; i++) {
		...
		for (var j = 0; j < displayedLabels.length; j++) {
			...
			if (!existsTextCfg.obb) existsTextCfg.obb = new OrientedBoundingRect(existsTextCfg.localRect, existsTextCfg.transform);
			if (!obb) obb = new OrientedBoundingRect(localRect, transform);
...
function alignScaleTicks(scale, axisModel, alignToScale) {
	...
	var min = rawExtent[0];
	var max = rawExtent[1];
	if (isMinFixed && isMaxFixed) interval = (max - min) / alignToSplitNumber;
	else if (isMinFixed) {
	...
	if (ticks[1] && (!isValueNice(interval) || getPrecisionSafe(ticks[1].value) > getPrecisionSafe(interval))) warn("The ticks may be not readable when set min: " + axisModel.get("min") + ", max: " + axisModel.get("max") + " and alignTicks: true");
}
//#endregion
	...
	Grid.prototype.update = function(ecModel, api) {
		...
		function updateAxisTicks(axes) {
			...
			for (var i = len - 1; i >= 0; i--) {
				...
				if (isIntervalOrLogScale(scale) && model.get("alignTicks") && model.get("interval") == null) axisNeedsAlign.push(axis);
				else {
					niceScaleExtent(scale, model);
					if (isIntervalOrLogScale(scale)) alignTo = axis;
				}
			}
	...
	*/
	...
	Grid.create = function(ecModel, api) {
		...
		ecModel.eachSeries(function(seriesModel) {
			...
			seriesModel.coordinateSystem = gridModel.coordinateSystem.getCartesian(xAxisModel.componentIndex, yAxisModel.componentIndex);
		});
		return grids;
	};
...
var builders = {
	...
	axisTickLabel: function(opt, axisModel, group, transformGroup) {
		...
		if (axisModel.get(["axisLabel", "hideOverlap"])) hideOverlap(prepareLayoutList(map(labelEls, function(label) {
			return {
				label,
				priority: label.z2,
	...
	axisName: function(opt, axisModel, group, transformGroup) {
		...
		if (isNameLocationCenter(nameLocation)) labelLayout = AxisBuilder.innerTextLayout(opt.rotation, nameRotation != null ? nameRotation : opt.rotation, nameDirection);
		else {
...
function collectAxesInfo(result, ecModel, api) {
	...
	each$2(api.getCoordinateSystems(), function(coordSys) {
		...
		if (coordSys.getTooltipAxes && globalTooltipModel && baseTooltipModel.get("show")) {
			...
			if (triggerAxis || cross) each$2(tooltipAxes.baseAxes, curry(saveTooltipAxisInfo, cross ? "cross" : true, triggerAxis));
			if (cross) each$2(tooltipAxes.otherAxes, curry(saveTooltipAxisInfo, "cross", false));
		}
...
var CartesianAxisView = function(_super) {
	...
	*/
	CartesianAxisView.prototype.render = function(axisModel, ecModel, api, payload) {
		...
		var axisBuilder = new AxisBuilder(axisModel, extend({ handleAutoShown: function(elementType) {
...
var RadarView = function(_super) {
	...
	RadarView.prototype._buildAxes = function(radarModel) {
		...
		each$2(map(radar.getIndicatorAxes(), function(indicatorAxis) {
	...
	RadarView.prototype._buildSplitLineAndArea = function(radarModel) {
		...
		var lineStyle = lineStyleModel.getLineStyle();
		var areaStyle = areaStyleModel.getAreaStyle();
		each$2(splitAreas, function(splitAreas, idx) {
		...
		each$2(splitLines, function(splitLines, idx) {
...
var View = function(_super) {
	...
	*/
	...
	View.prototype.setZoom = function(zoom) {
		...
		if (zoomLimit) {
			if (zoomLimit.max != null) zoom = Math.min(zoomLimit.max, zoom);
...
function setGeoCoords(geo, model) {
	each$2(model.get("geoCoord"), function(geoCoord, name) {
...
var geoCreator = new (function() {
	...
	GeoCreator.prototype.create = function(ecModel, api) {
		...
		ecModel.eachComponent("geo", function(geoModel, idx) {
			...
			var geo = new Geo(mapName + idx, mapName, extend({ nameMap: geoModel.get("nameMap") }, getCommonGeoProperties(geoModel)));
		...
		ecModel.eachSeries(function(seriesModel) {
			if (seriesModel.get("coordinateSystem") === "geo") seriesModel.coordinateSystem = geoList[seriesModel.get("geoIndex") || 0];
		});
		...
		each$2(mapModelGroupBySeries, function(mapSeries, mapType) {
			var geo = new Geo(mapType, mapType, extend({ nameMap: mergeAll(map(mapSeries, function(singleMapSeries) {
	...
	*/
	GeoCreator.prototype.getFilledRegions = function(originRegionArr, mapName, nameMap, nameProperty) {
		...
		each$2(geoSourceManager_default.load(mapName, nameMap, nameProperty).regions, function(region) {
...
var GeoModel = function(_super) {
	...
	GeoModel.prototype.init = function(option, parentModel, ecModel) {
		...
		if (source && source.type === "geoJSON") {
			...
			if (!("color" in itemStyle)) itemStyle.color = "#eee";
		}
...
var RoamController = function(_super) {
	...
	RoamController.prototype._mousedownHandler = function(e) {
		if (isMiddleOrRightButtonOnMouseUpDown(e)) return;
		var el = e.target;
		while (el) {
	...
	RoamController.prototype._mousemoveHandler = function(e) {
		if (!this._dragging || !isAvailableBehavior("moveOnMouseMove", e, this._opt) || e.gestureEvent === "pinch" || isTaken(this._zr, "globalPan")) return;
		var x = e.offsetX;
		var y = e.offsetY;
		var oldX = this._x;
		var oldY = this._y;
	...
	RoamController.prototype._mouseupHandler = function(e) {
		if (!isMiddleOrRightButtonOnMouseUpDown(e)) this._dragging = false;
	};
	...
	RoamController.prototype._pinchHandler = function(e) {
		if (isTaken(this._zr, "globalPan")) return;
...
var MapDraw = function() {
	...
	MapDraw.prototype.draw = function(mapOrGeoModel, ecModel, api, fromView, payload) {
		...
		if (!regionsGroup.childAt(0) || payload) {
			...
			group.dirty();
		} else updateProps(group, transformInfoRoam, mapOrGeoModel);
	...
	MapDraw.prototype._buildSVG = function(viewBuildCtx) {
		...
		each$2(this._svgGraphicRecord.named, function(namedItem) {
			...
			if (OPTION_STYLE_ENABLED_TAG_MAP.get(svgNodeTagLower) != null && el instanceof Displayable) applyOptionStyleForRegion(viewBuildCtx, el, dataIdx, regionModel);
	...
	*/
	registers.registerAction({
		...
		ecModel.eachComponent({
			...
			if (componentType === "series") each$2(componentModel.seriesGroup, function(seriesModel) {
...
function mergeAxisOptionFromParallel(option) {
	each$2(normalizeToArray(option.parallelAxis), function(axisOption) {
...
var ParallelModel = function(_super) {
	...
	*/
	...
	ParallelModel.prototype._initDimensions = function() {
		...
		each$2(filter(this.ecModel.queryComponents({ mainType: "parallelAxis" }), function(axisModel) {
	...
	*/
	BrushController.prototype.setPanels = function(panelOpts) {
		if (panelOpts && panelOpts.length) {
			...
			each$2(panelOpts, function(panelOpts) {
...
var VisualMapping = function() {
	...
	*/
	VisualMapping.eachVisual = function(visual, callback, context) {
		if (isObject$1(visual)) each$2(visual, callback, context);
...
var Line = function(_super) {
	...
	Line.prototype._createLine = function(lineData, idx, seriesScope) {
		...
		var line = createLine(lineData.getItemLayout(idx));
		line.shape.percent = 0;
		initProps(line, { shape: { percent: 1 } }, seriesModel, idx);
		this.add(line);
...
//#endregion
export { RoamController as A, getAxisInfo as B, BrushController as C, onIrrelevantElement as D, MapDraw as E, install$3 as F, shiftLayoutOnY as G, AxisBuilder as H, rectCoordAxisBuildSplitArea as I, rectCoordAxisHandleRemove as L, geoSourceManager_default as M, View as N, updateViewOnPan as O, install$2 as P, AxisView as R, makeRectPanelClipPath as S, install$1 as T, layout as U, makeKey as V, axisModelCreator as W, isEC4CompatibleStyle as _, Symbol as a, makeLinearBrushOtherExtent as b, VisualMapping as c, applyLeaveTransition as d, applyUpdateTransition as f, convertToEC4StyleForCustomSerise as g, convertFromEC4CompatibleStyle as h, SymbolDraw as i, updateCenterAndZoom as j, updateViewOnZoom as k, applyKeyframeAnimation as l, updateLeaveTo as m, LineDraw as n, getDefaultInterpolatedLabel as o, isTransitionAll as p, Line as r, getDefaultLabel as s, isCoordinateSystemType as t, stopPreviousKeyframeAnimationAndRestore as u, warnDeprecated as v, sliderMove as w, makeRectIsTargetByCursor as x, install as y, collect as z };

//# sourceMappingURL=CoordinateSystem-65XaTzbp.js.map