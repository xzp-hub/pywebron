import { An as isDom, Bn as keys, Cn as filter, En as indexOf, Fn as isObject, G as getBoundingRect, Gn as mixin, H as Displayable, Hn as map, In as isRegExp, It as translate, Kn as noop, Ln as isString, M as ZRImage, O as encodeHTML, On as isArray$1, Pn as isNumber, Pt as rotate, Sn as extend, Tn as hasOwn, Un as merge, Vn as logError, Wn as mergeAll, X as Point, Xn as retrieve2, Y as BoundingRect, Yn as retrieve, _ as stop, _n as curry$1, bn as each$9, d as Group$2, er as trim$1, fn as assert, g as normalizeEvent, gn as createHashMap, jn as isFunction, k as transformLocalCoord, kn as isArrayLike, kt as create$1, ln as parse, m as addEventListener, mn as clone$1, pn as bind$1, q as parsePercent, sn as modifyAlpha, tn as env, un as stringify, v as ZRText, vn as defaults, x as Rect$1 } from "./graphic-Bd3Ikl7D.js";
import { $r as getTooltipRenderMode, A as getStackedDimension, Ai as parsePercent$1, Bn as setLabelStyle, Bt as createFilterComparator, C as IntervalScale, Cr as Polygon, Ct as clear$1, Dr as Circle, Ei as linearMap$2, En as windowOpen, Fr as enterEmphasis, Gn as createIcon, Hn as applyTransform, Hr as setStatesStylesFromModel, Ht as parseDataValue, In as createTextStyle, It as SourceManager, Jn as getShapeClass, Jr as SINGLE_REFERRING, Li as __extends, Ln as getFont, Lr as leaveBlur, Lt as disableTransformOptionMerge, M as SeriesData, Mn as inheritDefaultOption, Mr as enableHoverEmphasis, Mt as buildTooltipMarkup, Nn as Model, Nt as createTooltipMarkup, On as format, Ot as ComponentView, Pi as reformIntervals, Pr as enterBlur, Pt as getPaddingFromTooltipModel, Q as registerAction, Qn as linePolygonIntersect, Qr as getDataItemValue, Rn as getLabelStatesModels, Rr as leaveEmphasis, Si as getPrecision, Sn as formatTplSimple, Sr as Polyline, St as setItemVisualFromData, Tn as toCamelCase, Tr as Sector, Ur as toggleHoverEmphasis, Ut as DataFormatMixin, Vt as getRawValueParser, Wr as getECData, Wt as normalizeTooltipFormatResult, Xn as graphic_exports, Xr as convertOptionIdName, Xt as registerInternalOptionCreator, Yn as getTransform, Yr as compressBatches, Yt as getDecalFromPalette, Zn as groupTransition, Zr as defaultEmphasis, _ as ensureScaleRawExtentInfo, _t as symbolBuildProxies, a as contain, ai as mappingToExists, bt as getItemVisualFromData, c as createScaleByModel$1, ci as preParseFinder, cn as box, d as getDataDimensionsOnAxis, di as deprecateLog, fn as getLayoutParams, g as unionAxisExtentFromData, gi as warn, gn as sizeCalculable, gt as normalizeSymbolSize, hi as throwError, hn as positionElement, ht as normalizeSymbolOffset, ii as makeInternalComponentId, ir as setTooltipConfig, j as isDimensionStacked, jn as getUID, jt as TooltipMarkupStyleCreator, ki as parseDate, kn as getLocaleModel, li as queryDataIndex, ln as copyLayoutParams, m as niceScaleExtent, mi as makePrintable, mn as mergeLayoutParam, mr as updateProps$1, mt as createSymbol, ni as isNameSpecified, o as use, oi as normalizeToArray, on as ComponentModel, or as subPixelOptimizeLine, pn as getLayoutRect, pt as createOrUpdatePatternFromDecal, qr as MULTIPLE_REFERRING, ri as makeInner, s as AxisModelCommonMixin, si as parseFinder$1, sn as LOCATION_PARAMS, sr as transformDirection, t as Axis, tn as SERIES_LAYOUT_BY_COLUMN, tr as mergePath, u as getAxisRawValue, ui as queryReferringComponents, v as TimeScale, vi as asc$2, vr as LinearGradient, vt as findEventDispatcher, w as OrdinalScale, wn as normalizeCssArray, wr as Ring, wt as createOrUpdate, xi as getPixelPrecision, xn as formatTpl, xr as Line, xt as getVisualFromData, yn as convertToColorString, z as DataDiffer, zr as setAsHighDownDispatcher, zt as SortOrderComparator } from "./Axis--lthWc4Q.js";
import { A as RoamController, B as getAxisInfo$1, C as BrushController, F as install$11, H as AxisBuilder, I as rectCoordAxisBuildSplitArea, L as rectCoordAxisHandleRemove, P as install$20, R as AxisView, S as makeRectPanelClipPath, T as install$8, U as layout$2, V as makeKey, W as axisModelCreator, _ as isEC4CompatibleStyle, b as makeLinearBrushOtherExtent, c as VisualMapping, d as applyLeaveTransition, f as applyUpdateTransition, h as convertFromEC4CompatibleStyle, i as SymbolDraw, l as applyKeyframeAnimation, m as updateLeaveTo, n as LineDraw, p as isTransitionAll, t as isCoordinateSystemType, u as stopPreviousKeyframeAnimationAndRestore, w as sliderMove, x as makeRectIsTargetByCursor, y as install$18, z as collect } from "./CoordinateSystem-65XaTzbp.js";
...
var BaseAxisPointer = function() {
	...
	*/
	BaseAxisPointer.prototype.createPointerEl = function(group, elOption, axisModel, axisPointerModel) {
		...
		if (pointerOption) {
			var pointerEl = inner$11(group).pointerEl = new graphic_exports[pointerOption.type](clone(elOption.pointer));
			group.add(pointerEl);
		}
	};
	/**
	...
	*/
	BaseAxisPointer.prototype.createLabelEl = function(group, elOption, axisModel, axisPointerModel) {
		if (elOption.label) {
			var labelEl = inner$11(group).labelEl = new ZRText(clone(elOption.label));
			group.add(labelEl);
...
var CartesianAxisPointer = function(_super) {
	...
	*/
	CartesianAxisPointer.prototype.makeElOption = function(elOption, value, axisModel, axisPointerModel, api) {
		...
		buildCartesianSingleLabelElOption(value, elOption, layout$2(grid.model, axisModel), axisModel, axisPointerModel, api);
	};
	/**
	* @override
	*/
	CartesianAxisPointer.prototype.getHandleTransform = function(value, axisModel, axisPointerModel) {
		var layoutInfo = layout$2(axisModel.axis.grid.model, axisModel, { labelInside: false });
...
function buildPayloadsBySeries(value, axisInfo) {
	...
	each$9(axisInfo.seriesModels, function(series, idx) {
		...
		if (series.getAxisTooltipData) {
			...
			dataIndices = series.getData().indicesOfNearest(dataDim[0], value, axis.type === "category" ? .5 : null);
...
var Polar = function() {
	...
	*/
	Polar.prototype.coordToPoint = function(coord) {
		...
		return [Math.cos(radian) * radius + this.cx, -Math.sin(radian) * radius + this.cy];
	};
	/**
...
var RadiusAxisView = function(_super) {
	...
	RadiusAxisView.prototype.render = function(radiusAxisModel, ecModel) {
		...
		var axisBuilder = new AxisBuilder(radiusAxisModel, layoutAxis(polar, radiusAxisModel, axisAngle));
...
var SingleAxisView = function(_super) {
	...
	SingleAxisView.prototype.render = function(axisModel, ecModel, api, payload) {
		...
		var axisBuilder = new AxisBuilder(axisModel, layout$1(axisModel));
		each$9(axisBuilderAttrs, axisBuilder.add, axisBuilder);
		group.add(this._axisGroup);
		group.add(axisBuilder.getGroup());
		each$9(selfBuilderAttrs, function(name) {
			if (axisModel.get([name, "show"])) axisElementBuilders[name](this, this.group, this._axisGroup, axisModel);
		}, this);
...
var Single = function() {
	...
	*/
	...
	Single.prototype.convertToPixel = function(ecModel, finder, value) {
		return getCoordSys$1(finder) === this ? this.dataToPoint(value) : null;
	};
	Single.prototype.convertFromPixel = function(ecModel, finder, pixel) {
		return getCoordSys$1(finder) === this ? this.pointToData(pixel) : null;
	};
	return Single;
}();
...
var SingleAxisPointer = function(_super) {
	...
	*/
	SingleAxisPointer.prototype.makeElOption = function(elOption, value, axisModel, axisPointerModel, api) {
		...
		buildCartesianSingleLabelElOption(value, elOption, layout$1(axisModel), axisModel, axisPointerModel, api);
	};
	/**
	* @override
	*/
...
var Calendar = function() {
	...
	*/
	...
	Calendar.prototype.update = function(ecModel, api) {
		...
		var calendarRect = this._rect = getLayoutRect(layoutParams, {
			width: api.getWidth(),
			height: api.getHeight()
		});
		each$9([0, 1], function(idx) {
	...
	*/
	Calendar.prototype.dataToPoint = function(data, clamp) {
		...
		if (clamp && !(dayInfo.time >= range.start.time && dayInfo.time < range.end.time + PROXIMATE_ONE_DAY)) return [NaN, NaN];
		var week = dayInfo.day;
		var nthWeek = this._getRangeInfo([range.start.time, date]).nthWeek;
		if (this._orient === "vertical") return [this._rect.x + week * this._sw + this._sw / 2, this._rect.y + nthWeek * this._sh + this._sh / 2];
	...
	*/
	...
	Calendar.create = function(ecModel, api) {
		...
		ecModel.eachSeries(function(calendarSeries) {
			if (calendarSeries.get("coordinateSystem") === "calendar") calendarSeries.coordinateSystem = calendarList[calendarSeries.get("calendarIndex") || 0];
		});
		return calendarList;
	};
	...
	DataZoomModel.prototype._fillAutoTargetAxisByOrient = function(targetAxisIndexMap, orient) {
		...
		function setParallelAxis(axisModels, axisDim) {
			...
			if (axisDim === "x" || axisDim === "y") {
				...
				gridModel_1 && each$9(axisModels, function(axModel) {
		...
		if (needAuto) each$9(DATA_ZOOM_AXIS_DIMENSIONS, function(axisDim) {
			if (!needAuto) return;
			var axisModels = ecModel.findComponents({
...
var AxisProxy = function() {
	...
	*/
	AxisProxy.prototype.calculateDataWindow = function(opt) {
		...
		var scale = this.getAxisModel().axis.scale;
	...
	*/
	...
	AxisProxy.prototype.filterData = function(dataZoomModel, api) {
		...
		each$7(seriesModels, function(seriesModel) {
			...
			} else each$7(dataDims, function(dim) {
...
var MagicType = function(_super) {
	...
	MagicType.prototype.onclick = function(ecModel, api, type) {
		...
		each$9(radioTypes, function(radio) {
			if (indexOf(radio, type) >= 0) each$9(radio, function(item) {
	...
	*/
	...
	BrushTargetManager.prototype.matchOutputRanges = function(areas, ecModel, cb) {
		each$9(areas, function(area) {
			...
			if (targetInfo && targetInfo !== true) each$9(targetInfo.coordSyses, function(coordSys) {
	...
	*/
	...
	TooltipHTMLContent.prototype.moveTo = function(zrX, zrY) {
		...
		if (styleCoord[0] != null && styleCoord[1] != null) {
			...
			each$9(assembleTransform(styleCoord[0], styleCoord[1]), function(transform) {
...
var TooltipView = function(_super) {
	...
	TooltipView.prototype.init = function(ecModel, api) {
		...
		this._tooltipContent = (this._renderMode = getTooltipRenderMode(tooltipModel.get("renderMode"))) === "richText" ? new TooltipRichContent(api) : new TooltipHTMLContent(api, { appendTo: tooltipModel.get("appendToBody", true) ? "body" : tooltipModel.get("appendTo", true) });
	};
	...
	*/
	...
	TooltipView.prototype._showTooltipContent = function(tooltipModel, defaultHtml, params, asyncTicket, x, y, positionExpr, el, markupStyleCreator) {
		...
		var nearPointColor = this._getNearestPoint([x, y], params, tooltipModel.get("trigger"), tooltipModel.get("borderColor")).color;
	...
	TooltipView.prototype._getNearestPoint = function(point, tooltipDataParams, trigger, borderColor) {
		if (trigger === "axis" || isArray$1(tooltipDataParams)) return { color: borderColor || (this._renderMode === "html" ? "#fff" : "none") };
...
function createScaleByModel(model, axisType) {
	...
	if (axisType) switch (axisType) {
		...
		default: return new IntervalScale();
	}
}
...
function dataTransform(seriesModel, item) {
	...
	if (item.coord == null || !isArray$1(dims)) item.coord = [];
	else {
	...
	MarkAreaView.prototype.renderSeries = function(seriesModel, maModel, ecModel, api) {
		...
		areaData.diff(inner$2(polygonGroup).data).add(function(idx) {
			...
			if (!layout.allClipped) {
				var polygon = new Polygon({ shape: { points: layout.points } });
			...
			if (!layout.allClipped) {
				if (polygon) updateProps$1(polygon, { shape: { points: layout.points } }, maModel, newIdx);
...
var LegendModel = function(_super) {
	...
	LegendModel.prototype._updateSelector = function(option) {
		...
		if (isArray$1(selector)) each$9(selector, function(item, index) {
...
var SliderZoomView = function(_super) {
	...
	SliderZoomView.prototype._prepareDataShadowInfo = function() {
		...
		var ecModel = this.ecModel;
		dataZoomModel.eachTargetAxis(function(axisDim, axisIndex) {
			each$9(dataZoomModel.getAxisProxy(axisDim, axisIndex).getTargetSeriesModels(), function(seriesModel) {
				if (result) return;
...
var VisualMapModel = function(_super) {
	...
	*/
	VisualMapModel.prototype.getTargetSeriesIndices = function() {
		...
		var seriesIndices = [];
		if (optionSeriesIndex == null || optionSeriesIndex === "all") this.ecModel.eachSeries(function(seriesModel, index) {
			seriesIndices.push(index);
		});
		else seriesIndices = normalizeToArray(optionSeriesIndex);
...
var VisualMapView = function(_super) {
	...
	*/
	VisualMapView.prototype.getControllerVisual = function(targetValue, visualCluster, opts) {
		...
		each$9(VisualMapping.prepareVisualTypes(mappings), function(type) {
			...
			if (showLabel) {
				...
				itemGroup.add(new ZRText({
					style: {
						...
						font: textFont,
						fill: textFill,
						opacity: visualState === "outOfRange" ? .5 : 1
					},
					silent
				}));
			}
